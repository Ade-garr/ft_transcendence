...
let MuteService = class MuteService {
    constructor(muteUserRepository) {
        this.muteUserRepository = muteUserRepository;
    }
    async create(userId, time, room) {
...
MuteService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(mute_entity_1.MuteEntity)),
